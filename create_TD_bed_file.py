...
#Usage: create_TD_bed_file.py [vcf.gz folder] [bed file output folder] [LS if LOWSUPPORT included]

if len(sys.argv) < 3:
    print ("Usage: create_TD_bed_file.py [vcf.gz folder] [bed file output folder] [LS if LOWSUPPORT included]")
    exit()
